"""
This script is called by the plugin-wrapper, PetriNetClassificationPlugin.js, which passes down the
...
from PetriNetClassificationPlugin import PetriNetClassificationPlugin

logger = logging.getLogger('PetriNetClassificationPlugin')
...
plugin = PetriNetClassificationPlugin(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
